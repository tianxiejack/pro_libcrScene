...
TranslationOutlierRejector::TranslationOutlierRejector():ransacParams_(RansacParams::translationMotionStd())
{
    setCellSize(Size(50, 50));
 //   setRansacParams(RansacParams::translationMotionStd());
}
TranslationOutlierRejector::~TranslationOutlierRejector()
{

}
void TranslationOutlierRejector::process(
